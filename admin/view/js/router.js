...
const routerTree = {
  ...
  shipmentdetails: {
    ...
    startingFunction: "shipmentdetailsActive",
    scriptName: `./js/shipmentdetails.js?q=${Math.random()}`,
  },
  shipment: {
    template: "shipment",
    startingFunction: "shipmentActive",
    scriptName: `./js/shipment.js?q=${Math.random()}`,
  },
};
