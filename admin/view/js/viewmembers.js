...
async function fetchviewmembers() {
    ...
    let request = await httpRequest2(`api/v1/members/finduser?role=MEMBER&status=ACTIVE&registrationpoint=${did('registrationpointsearch').tomselect.getValue()??0}`, null,  document.querySelector('#viewmembersform #submit'), 'json', 'GET');
